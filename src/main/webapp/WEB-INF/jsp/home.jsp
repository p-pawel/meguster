<html>
  ...
  <body>
    <div id="base" class="">
      ...
      <!-- baner (Dynamic Panel) -->
      <div id="u2" class="ax_dynamic_panel" data-label="baner">
        ...
        <div id="u2_state1" class="panel_state" data-label="State2">
      ...
      <div id="u17" class="ax_h1">
        ...
        <div id="u18" class="text">
          <p><span>Określ swój gust </span></p>
        </div>
      </div>
      ...
      <div id="u19" class="ax_h1">
        ...
        <div id="u20" class="text">
          <p><span>Poznaj ludzi o podobnym guście</span></p>
        </div>
      </div>
      ...
      <div id="u23" class="ax_vertical_line">
        ...
        <img id="u23_line" class="img " src="images/home/u23_line.png" alt="u23_line"/>
      </div>
      ...
      <div id="u24" class="ax_vertical_line">
        ...
        <img id="u24_line" class="img " src="images/home/u23_line.png" alt="u24_line"/>
      </div>
